...
int RS232::OpenComport(int comport_number, int baudrate, const char *mode)
{
  int baudr,
      status;
...
int RS232::PollComport(unsigned char *buf, int size)
{
  int n;
...
int RS232::SendBuf(unsigned char *buf, int size)
{
